(function (global) {
    ...
    var LANDMARK_CAPTIONS = [
        ...
        { re: /electric town|電氣街|akihabara|秋葉原/i, types: ['landmark', 'shopping'], caption: '秋葉原電氣街，動漫招牌與霓虹交織的街景。' }
    ];
    ...
    function generateCaption(ctx) {
        ...
        var sectionType = (ctx && ctx.sectionType) || 'landmark';
        var i;
        ...
        var place = (ctx && ctx.placeName) || (ctx && ctx.photoPlaceName) || (ctx && ctx.subject) || '';
        if (place) {
