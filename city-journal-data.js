    ...
    var ARTICLES = {
        tokyo: {
            anime: {
                ...
                styleKey: 'anime',
                status: 'published',
                title: '2026東京動漫主題專題：資深編輯帶路，挖掘次文化脈動',
                subtitle: '盛夏七月，東京動漫熱點深度攻略',
                editorialPlan: {
                    theme: '東京玩具動漫',
                ...
                intro: '2026年七月，東京的夏日氣息與動漫熱潮交織，這座城市再次成為全球次文化愛好者的焦點。我們深入秋葉原的電器街，尋訪中野百老匯的寶藏，體驗池袋的扭蛋樂趣。從深夜的一蘭拉麵到獨特的特色咖啡廳，再到舒適的住宿選擇，這份專題將帶領你避開觀光客的喧囂，直接切入東京動漫文化的核心。我們將揭示那些真正值得停留的場所，提供實用交通指引，確保你的東京動漫之旅既充實又道地。',
                sections: [
                    {
                        sectionId: 'akihabara',
                        ...
                        subject: '秋葉原電気街：動漫聖地巡禮的起點',
                        mapsQuery: 'Akihabara Electric Town',
                        placeId: 'ChIJAVf7lh2MGGARJylRnQ_3dpI',
                        googleRating: 4.5,
                        googleAddress: '〒101-0021 東京都千代田区外神田４丁目３−１',
                        googlePhotoUrl: 'https://lh3.googleusercontent.com/place-photos/AJRVUZN9mOR405czzkCfNO4zPJU7mgFm4Zu7lv7ysBn2AYMCC5qPByvTarMxlfpgvTwuEaxL3DrcVY5uaftmnu1opFYiZYtkWwodgCdeVF4UjIvAGjgf3eYBgBjuLP9H11XBP4h2D7dptqsgqf97fA=s4800-w1600-h1200',
                        ...
                        heading: '秋葉原電気街：動漫聖地巡禮的起點',
                        content: '來到秋葉原，直奔中央通與其周邊巷弄，這裡的「秋葉原電気街」是動漫周邊、模型與電子產品的集散地。建議從JR秋葉原站電器街口出站，沿主幹道向北步行，沿途的Animate、Mandarake等大型店鋪值得細逛。尤其假日中央通會實施步行者天國，逛起來更為舒適。記得多預留時間，這裡的店家密度高，很容易一待就是半天。',
                        editorialMeta: [
                    ...
                    },
                    {
                        ...
                        secondaryGoogleAttribution: null,
                        secondaryCaption: null,
                        heading: '中野ブロードウェイ：挖寶天堂的深度探索',
                        content: '從JR中野站北口出站，穿越商店街直達「中野ブロードウェイ」。這裡的特色是大量中古動漫周邊、漫畫與收藏品，尤其Mandarake系列店鋪佔據多個樓層，是尋找絕版品的寶庫。建議從二樓開始，沿著蜿蜒的走廊逐一探訪，許多小店藏在深處，需要耐心挖掘。注意，部分店家只收現金，務必準備足夠日幣。',
                        editorialMeta: [
                    ...
                    },
                    {
                        ...
                        heading: 'ガシャポン百貨店 池袋総本店：扭蛋迷的天堂',
                        content: '想體驗最純粹的扭蛋樂趣，務必前往「ガシャポン百貨店 池袋総本店」。從JR池袋站東口步行約5分鐘即可抵達，這間店擁有超過3000台扭蛋機，是全球最大的扭蛋專賣店。從經典動漫角色到搞怪小物，應有盡有。建議事先準備大量百元硬幣，或者直接在店內兌換，以免錯失心儀的款式。這裡的商品更新速度快，每次來都有新發現。',
                        editorialMeta: [
                    ...
                    },
                    {
                        ...
                        caption: '一蘭新宿店門口招牌與入口並列，紅白店招一眼可認。',
                        secondaryGooglePhotoUrl: null,
                        secondaryGoogleAttribution: null,
                        secondaryCaption: null,
                        heading: '新宿中央東口一蘭：豚骨拉麵',
                        content: '新宿中央東口店，JR新宿站東口步行3分即達。下到B1F，獨特味集中座席，客製化豚骨湯頭、麵條硬度與秘製醬汁。深夜覓食或逛街後，來碗熱騰騰拉麵最是滿足。尖峰時段雖需排隊，翻桌率高。',
                        editorialMeta: [
                    ...
                    },
                    {
                        ...
                        subject: 'めいどりーみん 秋葉原 本店：體驗女僕咖啡文化',
                        ...
                        caption: 'めいどりーみん本店樓層入口與店招清楚，方便確認樓別。',
                        ...
                        heading: 'めいどりーみん 秋葉原 本店：體驗女僕咖啡文化',
                        content: '來到秋葉原，不體驗女僕咖啡廳就少了點什麼。「めいどりーみん 秋葉原 本店」是該區最具代表性的女僕咖啡廳之一。從JR秋葉原站電器街口步行約5分鐘，店內女僕會與客人互動，並提供餐點與飲品。這裡的特色是充滿活力的服務與可愛的餐點擺盤，適合想體驗日本獨特次文化氛圍的讀者。建議預約或避開用餐高峰時段，以免排隊。',
                        editorialMeta: [
                    ...
                    },
                    {
                        ...
                        subject: 'グリッズ 東京 浅草橋 ホテル & ホステル：文青旅人的基地',
                        ...
                        secondaryGoogleAttribution: null,
                        secondaryCaption: null,
                        heading: 'グリッズ 東京 浅草橋 ホテル & ホステル：文青旅人的基地',
                        content: '尋找兼具設計感與社群氛圍的住宿，「グリッズ 東京 浅草橋 ホテル & ホステル」是個不錯的選擇。從JR淺草橋站東口步行約3分鐘，這家旅店提供多種房型，從膠囊床位到私人客房皆有。一樓的咖啡廳與酒吧是旅人交流的好地方，氣氛輕鬆。淺草橋地區交通便利，前往秋葉原、淺草等地都非常方便，是動漫迷與文青旅人的理想據點。',
                        editorialMeta: [
                    ...
                    },
                    {
                        ...
                        subject: 'ホテルグレイスリー新宿：哥吉拉主題的舒適住宿',
                        ...
                        caption: '哥吉拉頭像攀住飯店外牆，夜裡眼睛會亮起。',
                        secondaryGooglePhotoUrl: null,
                        secondaryGoogleAttribution: null,
                        secondaryCaption: null,
                        heading: 'ホテルグレイスリー新宿：哥吉拉主題的舒適住宿',
                        content: '若想在新宿享受更具主題性的住宿體驗，「ホテルグレイスリー新宿」絕對是首選。從JR新宿站東口步行約5分鐘，位於歌舞伎町中心，最吸睛的是八樓戶外露台的巨型哥吉拉頭像。部分客房甚至能直接看到哥吉拉，是動漫迷的一大亮點。酒店周邊餐飲娛樂設施豐富，交通便捷，適合追求便利與獨特體驗的旅客。建議提早預訂面哥吉拉的房型。',
                        editorialMeta: [
                ...
                outro: '這趟東京動漫之旅，不僅是視覺與味蕾的饗宴，更是深入城市脈動的文化探索。從秋葉原的熱鬧街景到新宿的夜生活，每個角落都藏著獨特的動漫故事。我們希望這份指南能助你規劃一趟專屬行程，無論是尋找稀有周邊、品嚐深夜美食，或是體驗特色住宿，都能找到最符合你期待的選擇。東京的動漫魅力遠不止於此，期待你親自來發掘更多驚喜。',
                cta: {
