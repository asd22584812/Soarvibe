    ...
    var ARTICLES = {
        tokyo: {
            anime: {
                ...
                editorialPlan: {
                    theme: '東京玩具動漫',
                    storyArc: '秋葉原街景朝聖 → 中野挖寶 → 池袋扭蛋與動漫聖地動線 → 美食咖啡補給 → 新宿住宿',
                    readingRhythm: '上午電氣街 → 午後中野 → 傍晚池袋 → 夜宿新宿'
                },
                articleTheme: '七月動漫聖地巡禮——街景、挖寶與池袋動線',
                ...
                issueLabel: '2026年7月號',
                intro: '七月東京悶熱但不躁，正是走進次文化街區的好時節。本期以兩日節奏安排：先在秋葉原電氣街感受招牌密度，午後移師中野挖二手寶，傍晚轉池袋扭蛋與聯名咖啡，夜宿新宿交通樞紐。每一步都對準「看得到街景、找得到店門」的動線。',
                sections: [
                    {
                        sectionId: 'akihabara',
                    ...
                    },
                    {
                        ...
                        caption: 'アニメイト池袋本店紅白立面與入口並列，是池袋動漫聖地動線的地標起點。',
                        secondaryGooglePhotoUrl: 'https://lh3.googleusercontent.com/place-photos/AG9NLjDXS9EYmoDVAjjfRngz76ZNZWSdplwLnpHoHGy1OLUeXzGitQxG3vJ4kuOfQKMnKvAPiCpC_35u9S6KJJc7C510FtVE3KMjyo1CCHy9uEUMv0JAPLhKF96eeMNyywm4CMzLr09B0cgsM2eeC1Y=s4800-w1600-h1200',
                        secondaryGoogleAttribution: 'F L',
                        secondaryCaption: 'アニメイト池袋本店的外觀與入口清楚可見，方便對照地圖找路。',
                        heading: '池袋アニメイトカフェ：聯名打卡',
                        content: '池袋的「アニメイトカフェ」常輪替聯名餐與特典，和ガシャポン百貨店、池袋動漫聖地動線可同一天連走。進店前查當期聯名與是否需事先預約，並確認低消與拍照規則。',
                        editorialMeta: [
                    ...
                    },
                    {
                        ...
                        subjectType: 'district',
                        sectionType: 'landmark',
                        visualKeywords: ['池袋', 'アニメイト', '乙女路', 'サンシャイン', '街並み', '動漫聖地'],
                        officialName: 'Sunshine City Ikebukuro',
                        officialNameLocal: 'サンシャインシティ',
                        aliases: ['Sunshine City', 'サンシャイン60通り', '池袋乙女路'],
                        photoIntent: '廣角街景、池袋動漫街區步行動線、サンシャイン通り或乙女路外觀，禁止海報特寫或室內',
                        imageChecklist: ['池袋', 'サンシャイン', 'アニメイト', '乙女路', '街', '外観'],
                        imageRejectRules: ['poster', '海報', '室内', 'indoor', 'food_dish', 'hotel', 'parking'],
                        subject: 'サンシャインシティ',
                        mapsQuery: 'Sunshine City Ikebukuro Tokyo',
                        placeId: 'ChIJU9ZPE2-NGGARwiJyx0Id61E',
                        googleRating: 4.2,
                        googleAddress: '〒170-8630 東京都豊島区東池袋３丁目１−２',
                        ...
                        caption: 'サンシャイン60通り街景與池袋東口商圈相接，步行動線清楚。',
                        secondaryGooglePhotoUrl: null,
                        secondaryGoogleAttribution: null,
                        secondaryCaption: null,
                        heading: '池袋動漫聖地：一日巡禮動線',
                        content: '池袋的動漫熱點適合串成一條步行線：從JR池袋東口出發，沿サンシャイン60通り走向アニメイト池袋本店，再轉進乙女路看角色周邊店。整段約一公里，建議預留兩小時邊走邊拍街景。',
                        editorialMeta: [
                            { icon: '⭐', label: '推薦程度', value: '動漫迷必走' },
                            { icon: '⏰', label: '建議停留', value: '2 小時' },
                            { icon: '🚉', label: '起點', value: 'JR 池袋（東口）' },
                            { icon: '📷', label: '最佳拍攝', value: '傍晚街燈亮起' }
                        ]
                    },
                    {
                ...
                outro: '動漫聖地巡禮的精髓在節奏，不在購物清單。七月這條路線把街景、挖寶、扭蛋與補給串在一起；下次來東京，你可以照著走，也可以只挑最對味的一段重訪。',
                cta: {
