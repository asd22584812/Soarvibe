(function (global) {
    ...
    META.tokyo.editionCoverGoogle = {
        budget: {
            googlePhotoUrl: 'https://lh3.googleusercontent.com/place-photos/AG9NLjDvqBUdZRMo5dwCMpVTdXeS8oIECAwpPFYSmN148AKty6oV5oZ_xoQ88lqzPHrotFKkTd8kkDIvm_2Yl6ul2yKaAzRehiUP4lFNHT25hthxs1NgtQGzxZVYhEtu0893fcoxf7b1ckO6Ay3xoA=s4800-w1600-h1200',
        ...
        foodie: {
            googlePhotoUrl: 'https://lh3.googleusercontent.com/place-photos/AG9NLjDYENz1Unj08zFk6LHZW8OjW9RUM2pO1fjDo6xNtHa2w0VRG0cMdizm40Fz07uLBI4oNOs_mk9hoA3BDGAsbTd_ZNDtQTnYL_u0DAt7oDORtpfFAQjG0vscpBwJy36k0z-c7J4mfsL-ZtwHzA=s4800-w1600-h1200',
    ...
    var ARTICLES = {
        tokyo: {
            anime: {
                ...
                styleKey: 'anime',
                status: 'published',
                title: '東京動漫次文化最前線：2026年七月東京深度探訪',
                subtitle: '七月動線：秋葉原認街、中野挖寶、池袋補貨、上野落腳',
                editorialPlan: {
                    theme: '東京玩具動漫',
                    storyArc: '秋葉原→中野→池袋→上野住宿',
                    readingRhythm: '上午電氣街 → 午後中野 → 傍晚池袋 → 夜宿上野'
                },
                articleTheme: '七月動漫聖地巡禮——街景、挖寶與池袋補給',
                editorialAngle: '先認識街區長相，再進店挖寶；住宿只留一間交通樞紐飯店',
                readerPersona: '動漫迷、老玩家、想深度逛秋葉原・中野・池袋的旅人',
                travelStyle: '步行掃街、深度挖寶、夜宿交通樞紐',
                emotion: '興奮、懷舊、驚喜挖到寶',
                articleGoal: '讓讀者先看懂街景動線，再決定要挖什麼、吃什麼、住哪裡',
                ...
                heroGooglePhotoUrl: 'https://lh3.googleusercontent.com/place-photos/AG9NLjABoYKWAQAxEWnZwL_SqW1C1vXQVChhP_YEo2NnFUNh3cLNfJMnQuDYfSIarxqDHV4F-7Wxg2xyZ3euCQMckEu12ziZNipobJT9EEDLfzHQ-a8S06z-4Fn4ZiS1c6qOglu_84AVi1KTC9Uu=s4800-w1600-h1200',
                ...
                issueLabel: '2026年7月號',
                intro: '七月東京悶熱，但電氣街一入夜就亮起來。這期把動線拆成四段：上午在秋葉原認街、下午鑽中野百老匯、傍晚轉池袋補貨，最後落腳上野，行李只搬一次。以下每段對應一張實拍——先看圖認路，再決定要挖什麼。',
                sections: [
                    {
                        sectionId: 'akihabara',
                        ...
                        subject: '秋葉原電気街：御宅族文化發源地',
                        mapsQuery: 'Akihabara Electric Town',
                        placeId: 'ChIJ__-AdayOGGAR6EGPwvcpzTA',
                        googleRating: 4.5,
                        googleAddress: '〒101-0021 東京都千代田区外神田１丁目１５−１６',
                        googlePhotoUrl: 'https://lh3.googleusercontent.com/place-photos/AG9NLjC6q0wsbpfX4F4ShZu2fhR5w-B0w7GHZX9vYYl9ZFJXr0wqDjJLD88uH1KQuieOa7NldS4oa531ZD8HS8afxtR-HwBPnoE6_8_TpbDbHhtSwovG26GIxsbbmfjFZUHnhoUBRrYY4XtwZLtlKds=s4800-w1600-h1200',
                        googleAttribution: 'Marta',
                        imageSource: 'google_places',
                        imageKey: 'tokyo-section-akihabara',
                        caption: '秋葉原ラジオ会館一帶的電氣街街景，兩側動漫與電器招牌密集，電氣街氛圍清楚可見。',
                        secondaryGooglePhotoUrl: null,
                        secondaryGoogleAttribution: null,
                        secondaryCaption: null,
                        heading: '秋葉原電気街：御宅族文化發源地',
                        content: '穿梭於秋葉原中央通兩側，大型電器行與動漫商店招牌林立，電子音樂與動畫主題曲交織成獨特街景。週末下午中央通會實施步行者天國，務必把握機會漫步其中，感受這股專屬的熱烈氣氛。',
                        editorialMeta: [
                    ...
                    },
                    {
                        ...
                        photoIntent: '中野百老匯商場外牆、入口招牌、NAKANO BROADWAY 立面，禁止雜貨店／食材店／室內走道',
                        imageChecklist: ['ブロードウェイ', 'Broadway', '中野', '外観', 'facade'],
                        ...
                        subject: '中野ブロードウェイ：懷舊寶藏的時光迴廊',
                        mapsQuery: 'Nakano Broadway entrance Tokyo',
                        placeId: 'ChIJg-7dspDyGGARvvDv4E5-tuE',
                        googleRating: 4.2,
                        googleAddress: '〒164-0001 東京都中野区中野５丁目５２−１５',
                        googlePhotoUrl: 'https://lh3.googleusercontent.com/place-photos/AG9NLjDgwCb_1dUwWnDRggKVGqZzFLesGoERepbLbDSYbvKDGcnoVbSf3FnrClD9to5FL0NM-mLF8Drf3j8ei6wShQmhb7FKv6qwpD3-vX5ZhFiR9bzV8qjvx7mIHlUI2FlRXCpWijOyt49uJmLdJH7bciKz2A=s4800-w1600-h1200',
                        googleAttribution: 'zox Tomo',
                        imageSource: 'google_places',
                        imageKey: 'tokyo-section-nakano',
                        caption: '中野ブロードウェイ外觀街景，Broadway 招牌與中野五丁目街區立面清楚可辨。',
                        secondaryGooglePhotoUrl: null,
                        secondaryGoogleAttribution: null,
                        secondaryCaption: null,
                        heading: '中野ブロードウェイ：懷舊寶藏的時光迴廊',
                        content: '中野車站北口出來，通過陽光商店街直達中野百老匯入口。這座複合式商場外觀樸實，內部卻是動漫、漫畫、偶像周邊的寶庫。建議預留至少半天時間，深入探索各樓層的特色小店。',
                        editorialMeta: [
                    ...
                    },
                    {
                        ...
                        aliases: ['Gashapon Bandai Official Shop Ikebukuro', 'ガシャポンのデパート 池袋本店'],
                        ...
                        mapsQuery: 'ガシャポンのデパート 池袋本店',
                        placeId: 'ChIJAX6RgpONGGAR5hVdlYCQINI',
                        googleRating: 4,
                        googleAddress: '〒170-0013 東京都豊島区東池袋３丁目１−３ サンシャインシティワールドインポートマートビル 3F',
                        googlePhotoUrl: 'https://lh3.googleusercontent.com/place-photos/AG9NLjAkzTlhLGCQNSkgFDEXEsSNzdbeGpVd-6as7PLVcHulaTgLyAOWGsN5j0Q5e2QZoQu72EbmnK0Qh9ZDYAITUtJij25Nepbu8bzqbpPyG04yq9rGAKJmxqCwY2BUWdZ46Le0-E-VS9en0dzHULnPa35s=s4800-w1600-h1200',
                        googleAttribution: 'ガチャガチャの森池袋サンシャインシティアルタ店',
                        imageSource: 'google_places',
                        ...
                        secondaryGoogleAttribution: null,
                        secondaryCaption: null,
                        heading: 'ガシャポン百貨店 池袋総本店：扭蛋宇宙的無限可能',
                        content: '池袋太陽城購物中心三樓的ガシャポン百貨店，門口數百台扭蛋機一字排開，視覺效果震撼。這裡匯集了最新動漫角色到經典懷舊款，是尋找獨特小物的最佳地點，建議準備足夠零錢。',
                        editorialMeta: [
                    ...
                    },
                    {
                        ...
                        sectionRole: 'food',
                        sectionType: 'food',
                        visualKeywords: ['拉麵', '柚子', 'AFURI', '阿夫利', 'ramen'],
                        officialName: 'AFURI Ebisu',
                        officialNameLocal: 'AFURI 恵比寿',
                        aliases: ['AFURI 恵比寿', '阿夫利 恵比寿', 'AFURI Ebisu'],
                        ...
                        googleRating: null,
                        googleAddress: '〒150-0013 東京都渋谷区恵比寿１丁目１−７ 117ビル 1F',
                        googlePhotoUrl: 'https://lh3.googleusercontent.com/place-photos/AG9NLjAygEOt4rhiPMnP-vmpRsTM-C6rIFQOeQXEc3736ZgqMeBG29bIk0ZgQM_mjM3RMabq9spC13JKslzet7ZiNnm8O9qL0Srj1jbbagAYeqNmSTa5h5YJt6wPP1hEYwpWGOcCIvEHkl6GwTzN=s4800-w1600-h1200',
                        googleAttribution: 'AFURI 恵比寿',
                        imageSource: 'google_places',
                        imageKey: 'tokyo-section-ichiran',
                        caption: 'AFURI 恵比寿 117ビル一樓店門口，黑色招牌與簡約外觀清楚可辨。',
                        secondaryGooglePhotoUrl: null,
                        secondaryGoogleAttribution: null,
                        secondaryCaption: null,
                        heading: 'AFURI 恵比寿：柚子香氣的清爽拉麵',
                        content: '位於惠比壽車站附近，以清爽的柚子鹽拉麵聞名。店內採開放式廚房設計，可見師傅烹煮過程。高峰時段常需排隊20-30分鐘，建議避開用餐尖峰，體驗其獨特的炭烤豬肉與柑橘香氣。',
                        editorialMeta: [
                            { icon: '🍜', label: '推薦餐點', value: '柚子鹽拉麵' },
                            { icon: '💴', label: '預算', value: '¥1,000–1,400' },
                            { icon: '⏰', label: '建議停留', value: '30–45 分鐘' },
                            { icon: '🚉', label: '最近車站', value: 'JR 恵比寿' }
                        ]
                    },
                    {
                        sectionId: 'maid-cafe',
                        sectionRole: 'cafe',
                        sectionType: 'cafe',
                        visualKeywords: ['女僕', '咖啡', '甜點', 'maid', '主題咖啡', '@home'],
                        officialName: 'at-home cafe 秋葉原本店',
                        officialNameLocal: '＠ほぉ～むカフェ 秋葉原本店',
                        aliases: ['@home cafe', '@home cafe 秋葉原', 'アットホームカフェ', '＠ほぉ～むカフェ', 'at-home cafe'],
                        photoIntent: '店內主題空間、座位區，其次門口招牌',
                        imageChecklist: ['@home', 'home cafe', 'メイド', 'cafe', 'ほぉ'],
                        imageRejectRules: ['parking', 'bathroom', 'manga shelf'],
                        subject: '＠ほぉ～むカフェ 秋葉原本店',
                        mapsQuery: 'at-home cafe 秋葉原本店',
                        placeId: 'ChIJFw0-qR2MGGARK8G9zFZx69w',
                        googleRating: 4.3,
                        googleAddress: '〒101-0021 東京都千代田区外神田１丁目１１−４ ミツワビル 3-7F',
                        googlePhotoUrl: 'https://lh3.googleusercontent.com/place-photos/AG9NLjAGFZ-ITA7fsI7QZm-9ETxP_ANj1OLe7nvToaIp-m_0aSotQgYNAWLMZBL_OimNm2ArvkYnKb9reUHTyBRz4u6bOvPMqJkZ-m2JeBs1cphTiRmaF0rwTAm8qJ5VFTmEPa3Ncj2cKUrT7r0MPtw=s4800-w1600-h1200',
                        googleAttribution: 'at-home cafe 秋葉原本店',
                        imageSource: 'google_places',
                        imageKey: 'tokyo-section-maid-cafe',
                        caption: '＠ほぉ～むカフェ店內：粉色長椅、木桌與牆上女僕相框，主題空間清楚可辨。',
                        secondaryGooglePhotoUrl: null,
                        secondaryGoogleAttribution: null,
                        secondaryCaption: null,
                        heading: '@home cafe 秋葉原：經典女僕咖啡',
                        content: '外神田ミツワビル的「at-home cafe 秋葉原本店」是女僕咖啡指標店。進店後是粉白主題座位區；先確認低消、拍照規則與排隊情形，尖峰建議預留四十分鐘以上。',
                        editorialMeta: [
                    ...
                    {
                        sectionId: 'ikebukuro-route',
                        sectionRole: 'anime',
                        subjectType: 'venue',
                        sectionType: 'shopping',
                        visualKeywords: ['アニメイト', 'Animate', '池袋', '本店', '外観', '動漫聖地'],
                        officialName: 'Animate Ikebukuro',
                        officialNameLocal: 'アニメイト池袋本店',
                        aliases: ['アニメイト池袋本店', 'Animate Ikebukuro', 'Animate Ikebukuro Flagship'],
                        photoIntent: '店門口、招牌、外觀優先，禁止室內貨架特寫',
                        imageChecklist: ['アニメイト', 'animate', '外観', '入口', '池袋'],
                        imageRejectRules: ['poster', '海報', '室内', 'indoor', 'food_dish', 'hotel', 'parking'],
                        subject: 'アニメイト池袋本店',
                        mapsQuery: 'アニメイト池袋本店',
                        placeId: 'ChIJi0VhQ2-NGGARGsbajebyPVA',
                        googleRating: 4.2,
                        googleAddress: '〒170-0013 東京都豊島区東池袋１丁目２０−７',
                        googlePhotoUrl: 'https://lh3.googleusercontent.com/place-photos/AG9NLjDDoYLYXtai18ZOb5HLZyLF8x3gIkzV8DvX0lwmTGHRj7jm8aPngYMjLN2yfK6ZjXuBaovYnwdIVY1nKH8sr_0eFmU0ImeQmba6HVjR4gbl8KO_RHk4-IuX_hffyW72lkRRIVOGgJx_iJvmfg=s4800-w1600-h1200',
                        googleAttribution: 'Pluto Uno',
                        imageSource: 'google_places',
                        imageKey: 'tokyo-section-ikebukuro-route',
                        caption: 'アニメイト池袋本店外觀與招牌，沿池袋東口商圈步行即可抵達。',
                        secondaryGooglePhotoUrl: null,
                        secondaryGoogleAttribution: null,
                        secondaryCaption: null,
                        heading: '池袋動漫聖地巡禮動線：乙女路的魅力探索',
                        content: '從池袋東口出發，沿サンシャイン通り步行至アニメイト池袋本店，約15分鐘。接著轉入乙女路，探索販售BL漫畫與女性向周邊的特色店鋪。建議停留3-4小時，感受這裡獨特的文化氛圍。',
                        editorialMeta: [
                            { icon: '⭐', label: '推薦程度', value: '動漫迷必訪' },
                            { icon: '⏰', label: '建議停留', value: '45–75 分鐘' },
                            { icon: '🚉', label: '最近車站', value: 'JR 池袋（東口）' },
                            { icon: '🛍', label: '必看', value: '期間限定・新刊牆' }
                        ]
                    },
                    {
                        ...
                        sectionRole: 'hotel',
                        sectionType: 'hotel',
                        visualKeywords: ['飯店', '外觀', '上野', 'MIMARU', 'ミマル'],
                        officialName: 'MIMARU TOKYO UENO EAST',
                        officialNameLocal: 'MIMARU東京 上野イースト',
                        aliases: ['MIMARU UENO EAST', 'MIMARU東京 上野イースト', 'MIMARU TOKYO UENO EAST'],
                        photoIntent: '飯店外觀、建築入口優先，其次 Lobby，最後客房',
                        imageChecklist: ['MIMARU', 'ミマル', '外観', 'facade', 'entrance'],
                        imageRejectRules: ['parking', 'garage', 'restaurant only', 'resort', 'pool', 'unmade', 'messy bed'],
                        subject: 'MIMARU東京 上野イースト',
                        mapsQuery: '4-26-3 Higashiueno Taito Tokyo MIMARU',
                        placeId: 'ChIJNzPzFlaPGGARy9dNXr557qY',
                        googleRating: null,
                        googleAddress: '4-chōme-26-3 Higashiueno, Taito City, Tokyo 110-0015',
                        googlePhotoUrl: 'https://lh3.googleusercontent.com/place-photos/AG9NLjDTZCGS2Z5yXOpgrWGYej6ycOQd09AsJ8zBou01gFayAhH2r1el0iE_YP_QXqMtsC-SuBbPtniGnmcEvIjJ_K65f-tPtJT3aeNB7Sv_9c6ahqY1wxjg76If4boV0PolJ9RBr4SpELCq7zhl_a8-KRhHKQ=s4800-w1600-h1200',
                        googleAttribution: 'MIMARU東京 上野EAST',
                        imageSource: 'google_places',
                        imageKey: 'tokyo-section-hotel-gracery',
                        caption: 'MIMARU東京 上野イースト外觀，東上野街區建築立面與入口可辨。',
                        secondaryGooglePhotoUrl: null,
                        secondaryGoogleAttribution: null,
                        secondaryCaption: null,
                        heading: 'MIMARU 上野イースト：家族旅與長住友善',
                        content: '落在上野站東側的「MIMARU東京 上野イースト」，以帶小廚房的房型出名，適合動漫行程連住。從上野步行或搭一兩站就能回秋葉原、池袋；大廳與外觀辨識度高，check-in 前先拍一張入口確認位置。',
                        editorialMeta: [
                ...
                outro: '這條線把「看街景」和「進店挖寶」分開：秋葉原與中野適合放慢，池袋留給補貨與扭蛋。若只排兩天，優先秋葉原加池袋；有第三天再加中野。住宿選在上野，隔天搭 JR 回機場或轉往其他城市都省時。',
                cta: {
            ...
            sightseeing: {
                ...
                coverPlaceId: null,
                coverGooglePhotoUrl: 'https://lh3.googleusercontent.com/place-photos/AG9NLjCoAdnSSE4tHZh_EeqItgygqYXckBpskbM4ut57_sfOZZKkwlt3D6wRbDWNvTxG0xUFBWdRmwdkA6QoyRIINH42zlaZRWpAuQNvgp-gcBWBDIEv7jpFU-l2YhwbT7SEyDxFfHk6X3o261MvLg=s4800-w1600-h1200',
                coverGoogleAttribution: '쿰척',
                coverImageSource: 'google_places',
