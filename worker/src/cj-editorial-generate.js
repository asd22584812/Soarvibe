...
function buildGeneratePrompt(opts) {
  ...
  return [
    ...
    '2. 地區／商圈段落（akihabara、nakano）文案必須對應「廣角街景／地標外觀」；ikebukuro-route 寫 Animate 本店外觀與進店節奏，不可寫室內貨架特寫',
    '3. 圖片將事後以 Google Maps／Places 配對；圖說會依實際照片撰寫。若景點配不到合格照片，必須改寫為可搜尋到照片的真實店家／地標',
    '',
    '【硬性規定】',
    ...
    '9. ikebukuro-route 寫アニメイト池袋本店：東口步行可達、多層樓週邊、與アニメイトカフェ可連走，附建議停留時間',
...
function buildSectionCopyPrompt(section, place, article, photoCaption) {
  var roleHints = {
    ...
    'ikebukuro-route': 'アニメイト池袋本店：店門口外觀、多層樓週邊補給、與扭蛋／カフェ連走節奏',
